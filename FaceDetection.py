#FACE DETECTION CV
import cv2
CLASSIFIER_PATH = "Facedetection/haarcascade_frontalface_default.xml"  #Defining the Path
...
while(True):
    ...
    for face_dims in faces:
        ...
        frame = cv2.putText(frame,"Mid-Part", (mid_x, mid_y), cv2.FONT_HERSHEY_DUPLEX, 0.7, (0,0,255),2)   #Displaying Mid Part 
